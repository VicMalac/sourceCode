...
int main(void){
    long long i = 4532778771095; // Número do cartão (Esse número é válido: 4532778771095 371449635398431 5200828282828210 4111111111111111)
    ...
    if ((n1 == 0 && n2 == 0 && n3 == 0 && n4 == 4)){ //Dessa forma quer dizer que o cartão tem 13 dígitos
        ...
        int soma1 = n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13 + n14 + n15 + n16;
        if (soma1 % 10 == 0){
            printf("%s\n", banco);
        }
        else{
